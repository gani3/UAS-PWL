...
@section('content')
  <form class="" action="/peminjaman/update/{{$detail->id_peminjaman}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="date" name="tanggal_pinjam" value="{{$detail->tanggal_pinjam}}" class="form-control  @error('tanggal_pinjam') is-invalid @enderror" placeholder="Tanggal Peminjaman">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="date" name="tanggal_kembali" value="{{$detail->tanggal_kembali}}" class="form-control  @error('tanggal_kembali') is-invalid @enderror" placeholder="Tanggal Peminjaman">
            <div class="text-danger">

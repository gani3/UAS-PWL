...
@section('content')
  <form class="" action="/rakbuku/update/{{$detail->id_rak_buku}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="nama_rak"  value="{{$detail->nama_rak}}" class="form-control @error('nama_rak') is-invalid @enderror " placeholder="Nama Rak Buku">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="lokasi_rak"  value="{{$detail->lokasi_rak}}" class="form-control @error('lokasi_rak') is-invalid @enderror " placeholder="Lokasi Rak" >
            <div class="text-danger">
              @error('lokasi_rak')
                {{$message}}
              @enderror
...
@section('title_card','Edit Rak buku')
@section('breadcrumb','Edit rak buku')
